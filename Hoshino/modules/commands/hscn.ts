...
const command: HoshinoLia.Command = {
  manifest: {
    ...
    description:
      "Manage your Hcoins: earn coins, check your balance and gameid, or convert to money. Earning may incur costs.",
    category: "Economy",
      ...
      [
        {
          ...
          async deploy({ chat, event, hoshinoDB }) {
            ...
            try {
              ...
              console.error(`Error in hscn earn for user ${userID}:`, error);
              await chat.reply("An error occurred. Please try again later.");
            }
          },
        },
        {
          ...
          async deploy({ chat, event, hoshinoDB }) {
            ...
            try {
              ...
              console.error(`Error in hscn info for user ${userID}:`, error);
              await chat.reply("An error occurred. Please try again later.");
            }
          },
        },
            ...
            try {
              ...
              const costMessage =
                newCosts > earningCosts
                  ...
                  : "";
              await chat.reply(
                `Converted ${amount} Hcoin(s) to $${(
                  newBalance - balance
                ).toLocaleString("en-US")} balance!${costMessage}`
              );
            } catch (error) {
              console.error(`Error in hscn convert for user ${userID}:`, error);
              await chat.reply("An error occurred. Please try again later.");
            }
          },
        },
